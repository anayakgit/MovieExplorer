...
## Data Structure: 
- Trie (for fast search and autocomplete)
...
Displays movie suggestions as the user types, fetched from the API.

## Movie Details: 
Displays detailed information about a selected movie, including release date, genres, overview, and ratings.

## Trending Movies: 
Automatically fetches and stores trending movies in a Trie for faster future searches.

## Efficient Search: 
Combines Trie-based search and API-based suggestions for quick and relevant results.
